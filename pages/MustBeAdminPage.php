<!DOCTYPE html>
<html>
<title>Admin Content - The Right Write</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-grey w3-xlarge">
    <p class="w3-left">Admin-Exclusive Content</p>
    <p class="w3-right">
		...
		<?php
			...
			if (isset($_SESSION['type'])) {
				if ($_SESSION['type'] == 'Admin')
					...
					echo '<div class="w3-container"><p><b>You must log in as an Admin to view this content.</b></p></div>';
