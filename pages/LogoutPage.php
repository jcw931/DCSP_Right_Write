<!DOCTYPE html>
<html>
<title>The Right Write - Logout</title>
<meta charset="UTF-8">
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <p>You have signed out of your account.<br></p>
      </div>
      <div class="w3-container">
        <p>Click <a href="HomePage.php">Home</a> to go to Home, or click <a href="LoginPage.php">Login</a> to Login.</p>
      </div>
    </div>
  </div>
